package io.github.styzf.util.graphviz;
...
public class GraphvizUtils {
    ...
    /** 生成文件 */
    public static void toFile(Graph g, File dir, String name) {
        ...
        try {
            for (Format format : formats) {
                ...
                LOGGER.info("关系图 {} 格式：\tfile:///{}",
                        format.fileExtension, file.getAbsolutePath().replace('\\', '/'));
            }
        } catch (IOException e) {
