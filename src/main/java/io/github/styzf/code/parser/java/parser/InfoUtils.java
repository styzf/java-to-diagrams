...
class InfoUtils {
     ...
     * @param type nullable
     */
    static void addTypeInfo(JavaInfo classInfo, ResolvedReferenceTypeDeclaration rt, TypeDeclaration<?> type) {
        if (rt.isEnum()) {
        ...
        classInfo.sign = rt.getQualifiedName();
        classInfo.name = rt.getName();
     ...
     * 补充字段信息
     */
    static void addFieldInfo(JavaInfo info, ResolvedFieldDeclaration r, FieldDeclaration d) {
        info.name = r.getName();
     ...
     * @param d nullable
     */
    static void addMethodInfo(JavaInfo info, ResolvedMethodLikeDeclaration r, CallableDeclaration<?> d) {
     ...
     * GetSet方法判断
     */
    static void forGetSet(JavaInfo info, TypeDeclaration<?> type, ResolvedReferenceTypeDeclaration rt) {
        String name = null;
